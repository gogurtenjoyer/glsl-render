...
If your shader needs the input image dimensions, you can do so like this (check the `dither-bayer` shader for an example):
```python
...
## More Shaders
There's a lot more shaders made for this node here: https://github.com/helix4u/shader-dump  - thanks, helix4u!
